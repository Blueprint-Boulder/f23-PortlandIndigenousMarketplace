...
export default function Events({EventService}) {
  ...
  const eventDisplay = (event) => (
    ...
    <div className="bg-white shadow-lg rounded-lg p-4 max-w-sm mx-auto bm-4">
      <div className="mt-2">
        ...
        <div className="mt-3 text-gray-700">{event.date} • {event.startTime} - {event.endTime}</div>
  ...
  return (
    ...
    <div className=' w-screen pl-2 pr-2 flex flex-col items-left justify-between gap-2 mb-10'>
